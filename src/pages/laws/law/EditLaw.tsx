...
import { UpdateLawForm, UpdateLawSchema } from "./schemas/law.shema";
export default () => {
  ...
  const handleSubmit: SubmitHandler<UpdateLawForm> = async (values) => {
    ...
    navigator("/admin/laws", { resolve: false });
  };
  ...
  return (
    <Form onSubmit={handleSubmit} class="relative">
      ...
      <div class="flex items-center">
        ...
        <Show
          when={checkPermission(Permission.Remove, PermissionGroup.Law, auth)}
        >
          <Button
            color="danger"
            outlined
