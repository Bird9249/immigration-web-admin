...
export default () => {
    ...
    const [newsCategoriessForm, { Form, Field, FieldArray }] = createForm<UpdateNewCataegoriessForm>({
    ...
    const handleSubmit: SubmitHandler<UpdateNewCataegoriessForm> = async (values) => {
    ...
    return (
        <Form onSubmit={handleSubmit} class="relative">
            ...
            <div class="flex items-center">
                <Button type="submit" isLoading={newsCategoriessForm.submitting} class="mr-3">
                    ອັບເດດໂຮງແຮມ
                </Button>
                <Button
                    color="danger"
                    outlined
                    type="button"
                    isLoading={newsCategoriessForm.submitting}
